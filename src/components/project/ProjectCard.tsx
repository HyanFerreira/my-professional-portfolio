...
export function ProjectCard({
  ...
  return (
    ...
    >
      <Card className="group flex h-full transform-gpu flex-col overflow-hidden p-0 transition-[transform,border-color,box-shadow] duration-300 ease-out hover:border-accent/55 hover:[transform:translate3d(0,-0.375rem,0)]">
